...
export default function CaseStudies() {
  return (
    <section id="work" className="py-20 px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl sm:text-5xl font-bold font-futuristic tracking-futuristic text-text-light mb-12">Work</h2>
      <div className="grid gap-12 md:grid-cols-2">
        {caseStudies.map((study) => (
          <Link href={`/work/${study.slug}`} key={study.slug} className="group block">
            ...
            <h3 className="text-2xl font-bold font-futuristic tracking-futuristic text-text-light mb-2">{study.title}</h3>
