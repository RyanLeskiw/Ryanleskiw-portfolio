    ...
    <article className="py-16 px-4 sm:px-6 lg:px-8 bg-bg-dark">
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mb-12 border-b border-gray-800 pb-8">
          <h1 className="text-4xl sm:text-5xl font-bold font-futuristic tracking-futuristic text-text-light mb-4">{study.title}</h1>
        ...
        <div className="space-y-12">
          {study.sections.map((section, index) => (
            <div key={index}>
              <section>
                <h2 className="text-2xl font-bold font-futuristic tracking-futuristic text-text-light mb-4">{section.heading}</h2>
